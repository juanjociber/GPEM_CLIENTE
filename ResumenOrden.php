<?php
    ...
    if(empty($_SESSION['UserName']) || empty($_SESSION['CliId']) || empty($_SESSION['CliNombre'])){
        header("location:/gesman_cliente/Salir.php");
        exit();
    }
...
<body>
    ...
    <div class="container section-top">
        ...
        <div class="row mb-3 gpem-hide-print">
            <div class="col-12 btn-group" role="group" aria-label="Basic example">
                ...
                <button type="button" class="btn btn-outline-primary fw-bold" onclick="FnModalNuevoInforme(); return false;"><i class="bi bi-file-earmark-plus-fill"></i><span class="d-none d-sm-block"> Informe</span></button>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalNuevoInforme" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Generar Nuevo Informe</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>                
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="txtActividad" rows="2"><?php echo $Actividad; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <script src="/gesman_cliente/js/ResumenOrden.js"></script>
