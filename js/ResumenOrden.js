...
function FnModalNuevoInforme(){
    const modalNuevoInforme=new bootstrap.Modal(document.getElementById('modalNuevoInforme'), {
        keyboard: false
    }).show();
    return false;
}
...
async function FnAgregarInforme(){
    ...
    try {        
        ...
        //setTimeout(()=>{window.location.href='/informes/ResumenInforme.php?informe='+datos.id;},1000);
    } catch (error) {
